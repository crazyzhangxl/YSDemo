...
public final class CameraManager {
    ...
    public void openDriver(SurfaceHolder holder) throws IOException {
        ...
        reverseImage = prefs.getBoolean(YsConstant.KEY_REVERSE_IMAGE, false);
    }
     ...
     */
    public com.videogo.scan.main.PlanarYUVLuminanceSource  buildLuminanceSource(byte[] data, int width, int height) {
        Rect rect = getFramingRectInPreview();
        if (rect == null) {
            return null;
        }
        // Go ahead and assume it's YUV rather than die.
        return new com.videogo.scan.main.PlanarYUVLuminanceSource(data, width, height, rect.left, rect.top, rect.width(), rect.height(),
                reverseImage);
    }
